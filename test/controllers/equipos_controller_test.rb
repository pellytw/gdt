...
class EquiposControllerTest < ActionController::TestCase
  ...
  test "should create equipo" do
    assert_difference('Equipo.count') do
      post :create, equipo: { imagen: @equipo.imagen, nombre: @equipo.nombre, participante_id: @equipo.participante_id, tactica_id: @equipo.tactica_id }
    end
  ...
  test "should update equipo" do
    patch :update, id: @equipo, equipo: { imagen: @equipo.imagen, nombre: @equipo.nombre, participante_id: @equipo.participante_id, tactica_id: @equipo.tactica_id }
    assert_redirected_to equipo_path(assigns(:equipo))
  end
