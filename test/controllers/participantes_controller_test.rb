...
class ParticipantesControllerTest < ActionController::TestCase
  ...
  test "should create participante" do
    assert_difference('Participante.count') do
      post :create, participante: { apellido: @participante.apellido, apodo: @participante.apodo, imagen: @participante.imagen, nombre: @participante.nombre, user_id: @participante.user_id }
    end
  ...
  test "should update participante" do
    patch :update, id: @participante, participante: { apellido: @participante.apellido, apodo: @participante.apodo, imagen: @participante.imagen, nombre: @participante.nombre, user_id: @participante.user_id }
    assert_redirected_to participante_path(assigns(:participante))
  end
